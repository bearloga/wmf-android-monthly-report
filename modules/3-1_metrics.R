...
metrics <- data.frame(
  ...
  source = c(
    "in-app analytics (MobileWikiAppSessions)",
    "in-app analytics (MobileWikiAppSessions)",
    "in-app analytics (MobileWikiAppDailyStats)",
    "in-app analytics (MobileWikiAppDailyStats)",
    "in-app analytics (MobileWikiAppSessions)",
    "in-app analytics (MobileWikiAppSessions)",
    "in-app analytics (MobileWikiAppEdit)",
    "in-app analytics (Edit, Sessions)",
    "mediawiki_history",
    "in-app analytics (SuggestedEdits, Sessions)",
    "in-app analytics (MobileWikiAppSuggestedEdits)",
    "Suggested Edits backend db",
    "mediawiki_history",
    "mediawiki_history",
    "mediawiki_history",
    "in-app analytics (MobileWikiAppFeed)",
    "in-app analytics (MobileWikiAppFeed)",
    "server-side account creation logs"
  ),
